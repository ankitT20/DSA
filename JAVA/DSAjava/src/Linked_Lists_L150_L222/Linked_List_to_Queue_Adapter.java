...
public class Linked_List_to_Queue_Adapter {
    // Linked List to Queue Adapter L 174
...
Note -> The intention is to use linked list functions to achieve the purpose
of a queue. All the functions should work in constant time.
Input Format
